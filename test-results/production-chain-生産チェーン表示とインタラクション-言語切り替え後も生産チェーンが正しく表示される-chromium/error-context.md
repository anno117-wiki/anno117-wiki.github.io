...
- Name: production-chain.spec.ts >> 生産チェーン表示とインタラクション >> 言語切り替え後も生産チェーンが正しく表示される
- Location: tests\e2e\production-chain.spec.ts:168:7
...
- generic [ref=e1]:
  - banner [ref=e2]:
    ...
    - button "Toggle Language" [active] [ref=e4] [cursor=pointer]: 日本語
  ...
  - main [ref=e16]:
    - generic [ref=e19]:
      - generic [ref=e20]:
        ...
        - 'heading "生産チェーン: アンフォラ" [level=3] [ref=e22]'
      - generic [ref=e23]:
        - generic [ref=e25]:
          - generic [ref=e26]:
        ...
        - generic [ref=e55]:
          - generic [ref=e56]:
            - heading "生産チェーン" [level=4] [ref=e57]
            - img [ref=e59]:
              - generic [ref=e62]:
                - generic [ref=e66]: アンフォラ
