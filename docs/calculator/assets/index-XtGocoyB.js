...
//#endregion
//#region apps/calculator/src/ts/modules/GraphInteractionHandler.ts
var GraphInteractionHandler = class {
	svgElement;
	onViewBoxChange;
	cancelled = false;
	isDragging = false;
	...
	initialViewBox = null;
	constructor(svgElement, onViewBoxChange) {
	...
	bindTouchEvents() {
		...
		this.svgElement.addEventListener("touchend", (e) => {
			...
			if (this.activeTouches.size === 0) this.resetTouches();
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$4, [createBaseVNode("div", _hoisted_2$4, [
				...
				withDirectives(createBaseVNode("input", {
					...
					onInput: handleInput
				}, null, 40, _hoisted_3$4), [[vModelText, searchQuery.value]]),
...
var _hoisted_2$3 = { class: "tree-item-icon" };
var _hoisted_3$3 = ["src", "alt"];
var _hoisted_4$3 = { class: "tree-item-content" };
var _hoisted_5$3 = { class: "tree-item-name" };
var _hoisted_6$3 = {
	key: 0,
...
var TreeItem_default = /*#__PURE__*/ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			...
			}, [createBaseVNode("div", _hoisted_2$3, [createBaseVNode("img", {
				src: iconSrc.value,
				alt: displayName.value,
				class: "good-icon",
				onError: handleImageError
			}, null, 40, _hoisted_3$3)]), createBaseVNode("div", _hoisted_4$3, [createBaseVNode("span", _hoisted_5$3, toDisplayString(displayName.value), 1), __props.showTags ? (openBlock(), createElementBlock("span", _hoisted_6$3, [(openBlock(true), createElementBlock(Fragment, null, renderList(__props.good.tags, (tag) => {
...
var _hoisted_1$2 = ["data-category"];
var _hoisted_2$2 = [
	"aria-expanded",
	"aria-label",
	"onKeydown"
];
var _hoisted_3$2 = { class: "category-icon" };
var _hoisted_4$2 = { class: "category-name" };
var _hoisted_5$2 = { class: "category-count" };
var _hoisted_6$2 = { class: "expand-icon" };
var _hoisted_7$2 = {
	key: 0,
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				createBaseVNode("span", _hoisted_3$2, toDisplayString(__props.category.icon), 1),
				createBaseVNode("span", _hoisted_4$2, toDisplayString(categoryName.value), 1),
				createBaseVNode("span", _hoisted_5$2, "(" + toDisplayString(__props.goods.length) + ")", 1),
				createBaseVNode("span", _hoisted_6$2, toDisplayString(__props.expanded ? "▼" : "▶"), 1)
			], 40, _hoisted_2$2), __props.expanded ? (openBlock(), createElementBlock("div", _hoisted_7$2, [(openBlock(true), createElementBlock(Fragment, null, renderList(__props.goods, (good) => {
...
var _hoisted_2$1 = { class: "tree-content" };
var _hoisted_3$1 = {
	key: 0,
...
var _hoisted_6$1 = { class: "recent-header" };
var _hoisted_7$1 = { class: "recent-title" };
var _hoisted_8$1 = { class: "recent-list" };
...
//# sourceMappingURL=index-XtGocoyB.js.map